...
class LasairConfig(AlertStreamConfig):
    """Pydantic configuration model for LasairAlertStream (stub).
...
class LasairAlertStream(AlertStream):
    """Stub Lasair AlertStream that generates obviously-fake mock alerts.

    See https://lasair-ztf.lsst.ac.uk
    """
    ...
    def listen(self) -> None:
        ...
        while True:
            ...
            logger.debug(f'LasairAlertStream: mock alert {object_id}')
