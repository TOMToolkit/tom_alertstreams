...
class PittGoogleConfig(AlertStreamConfig):
    """Pydantic configuration model for PittGoogleAlertStream (stub).
...
class PittGoogleAlertStream(AlertStream):
    """Stub Pitt-Google AlertStream that generates obviously-fake mock alerts.

    See https://pittgooglebroker.readthedocs.io for the real broker.
    """
    ...
    def listen(self) -> None:
        ...
        while True:
            ...
            logger.debug(f'PittGoogleAlertStream: mock alert {object_id}')
