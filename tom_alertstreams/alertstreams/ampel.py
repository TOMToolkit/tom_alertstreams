...
class AmpelConfig(AlertStreamConfig):
    """Pydantic configuration model for AmpelAlertStream (stub).
...
class AmpelAlertStream(AlertStream):
    """Stub AMPEL AlertStream that generates obviously-fake mock alerts.
    """
    ...
    def listen(self) -> None:
        ...
        while True:
            counter += 1
            topic = topics[counter % len(topics)]  # round-robin
            ...
            logger.debug(f'AmpelAlertStream: mock alert {object_id}')
